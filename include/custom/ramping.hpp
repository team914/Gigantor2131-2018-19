...
public:
  ...
  /*
  * returns the area under the current linear ramp model
  */
  double triDistance(double endValue = 0);
  /*
  * returns the area under the changing ramp model
  */
  double trapDistance(double endValue = 0);
